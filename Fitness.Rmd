...
```{r distance, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
...
```{r distance2, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
#create month and day columns
merge_dis<-merge%>%
...
```{r Altitude, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
#create month and day columns
merge_alt<-merge%>%
  mutate(day=day(date),
...
### Daily activity
```{r Activity, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
#create month and day columns
merge_alt<-merge%>%
  mutate(day=day(date),
         month=month(date, label = TRUE),
...
It would seem i spend the most time in bed on Sundays and the least on Mondays. Well, at least now i know why i have been cranky on mMondays, my sleep pattern needs improvement for Mondays. 

```{r Quantity, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
#create month and day columns
merge_slp<-merge%>%
...
```{r Quality, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
#create month and day columns
...
```{r bpm, include=TRUE, out.height='85%', out.width='85%', fig.align='center', warning=FALSE}
#Pivot dataframe 
